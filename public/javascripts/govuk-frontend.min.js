...
class Component {
    ...
    checkInitialised() {
        ...
        if (
            ...
            (function (t, e) {
                return (
                    t instanceof HTMLElement && t.hasAttribute(`data-${e}-init`)
                );
            })(this.$root, e)
        )
...
function mergeConfigs(...t) {
    ...
    for (const i of t)
        for (const t of Object.keys(i)) {
            const n = e[t],
                s = i[t];
            isObject(n) && isObject(s)
                ? (e[t] = mergeConfigs(n, s))
                : (e[t] = s);
        }
    return e;
}
...
class Accordion extends ConfigurableComponent {
    constructor(t, e = {}) {
        (super(t, e),
            ...
            (this.sectionShowHideToggleClass =
    ...
    constructHeaderMarkup(t, e) {
        ...
        (c.classList.add(this.sectionShowHideToggleFocusClass),
            l.appendChild(c));
...
class CharacterCount extends ConfigurableComponent {
    ...
    constructor(t, e = {}) {
        ...
        if (
            !(s instanceof HTMLTextAreaElement || s instanceof HTMLInputElement)
        )
            throw new ElementError({
        ...
        if (o[0])
            throw new ConfigError(formatErrorMessage(CharacterCount, o[0]));
        ((this.i18n = new I18n(this.config.i18n, {
    ...
    updateScreenReaderCountMessage() {
        (this.isOverThreshold()
            ...
            (this.$screenReaderCountMessage.textContent =
        ...
        anyOf: [
            {
                required: ['maxwords'],
                errorMessage:
                    'Either "maxlength" or "maxwords" must be provided',
            },
            {
                required: ['maxlength'],
                errorMessage:
...
class Checkboxes extends Component {
    ...
    syncConditionalRevealWithInputState(t) {
        ...
        if (
            null != i &&
            i.classList.contains('govuk-checkboxes__conditional')
        ) {
            const e = t.checked;
    ...
    constructor(t, e = {}) {
        ...
        (n instanceof HTMLAnchorElement && (this.$skiplinkButton = n),
            ...
            'govukFrontendExitThisPageKeypress' in document.body.dataset ||
                ...
                (document.body.dataset.govukFrontendExitThisPageKeypress =
                    'true')),
    ...
    constructor(t, e = {}) {
        ...
        if (
            ...
            throw new ElementError({
                component: FileUpload,
                identifier:
                    'File input (`<input type="file">`) attribute (`id`)',
            });
